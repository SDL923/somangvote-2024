...
const Body = ({ aboutSectionRef, candidatesSectionRef }) => {
  ...
  const handleYoutubeClick = (youtubeLink, startTime) => {
    const urlWithTime = `${youtubeLink}&t=${startTime}s`;
    ...
    <>
      <Section ref={aboutSectionRef}>
        <Content>
          ...
          <br />
          <SmallName>빌립보서 2장 15절</SmallName>
        </Content>
      </Section>
      ...
      <Section2>
        ...
        <Content>
          2025년 소망대학부를 위한 2차 총회가 10월 27일 예배 후에 진행됩니다.
          <br />
          기도로 함께 준비해주세요.
        </Content>
      </Section2>
      ...
      <Section2>
        ...
        <Content>
          선거관리위원회는 선거관리위원장(18이해윤)의 위촉을 받은 7명으로 구성되어 선거 관련 업무를
          담당합니다.
          <br />
          <br />
          선거관리위원: 18이해윤 18김근지 18백주혜 18지영선 18최다윤 20이현진 21김서현 21신윤호
        </Content>
      </Section2>
          ...
          <tbody>
            {profiles.map((profile) => (
              <tr key={profile.id}>
                ...
                <td>
                  <ButtonRed onClick={() => handleYoutubeClick(profile.youtubeLink, profile.startTime)}>
